 ...
 *
 * **Example.**
 * Create labels with a custom labeling message.
 * Note: parameter references will be replaced accordingly.
 * See also [predefined parameters](https://www.jetbrains.com/help/teamcity/predefined-build-parameters.html).
 * ```
 * vcsLabeling {
 *   vcsRootId = "< id of a VCS root>"
...
open class VcsLabeling : BuildFeature {
    ...
    /**
     * Customize the VCS type-specific labeling message format.
     * Parameter references are supported.
     * By default, the labeling message is: <code>automatically created by TeamCity VCS labeling build feature</code>
     */
    var messageFormat by stringParameter()
