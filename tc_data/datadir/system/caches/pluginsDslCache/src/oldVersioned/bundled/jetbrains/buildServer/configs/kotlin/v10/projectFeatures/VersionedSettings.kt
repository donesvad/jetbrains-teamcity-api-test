...
open class VersionedSettings : ProjectFeature {
     ...
     * If this setting is empty, the default directory will be used.
     * Enter "." to save settings directly to the repository root.
     * Be aware, TeamCity may clear the target directory before uploading new files.
     * Use "." solely for repositories that should store nothing but TeamCity project settings.
     */
    var path by stringParameter("settingsPath")
