...
open class RunInDockerBuildFeature : BuildFeature {
    constructor(init: RunInDockerBuildFeature.() -> Unit = {}, base: RunInDockerBuildFeature? = null): super(base = base as BuildFeature?) {
        type = "RunInDocker"
        init()
    }
 ...
 */
fun BuildFeatures.runInDocker(base: RunInDockerBuildFeature? = null, init: RunInDockerBuildFeature.() -> Unit = {}) {
    feature(RunInDockerBuildFeature(init, base))
}
