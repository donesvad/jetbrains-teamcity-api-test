...
open class MavenCacheFeature : BuildFeature {
    constructor(init: MavenCacheFeature.() -> Unit = {}, base: MavenCacheFeature? = null): super(base = base as BuildFeature?) {
 ...
 */
fun BuildFeatures.mavenCache(base: MavenCacheFeature? = null, init: MavenCacheFeature.() -> Unit = {}) {
    feature(MavenCacheFeature(init, base))
}
