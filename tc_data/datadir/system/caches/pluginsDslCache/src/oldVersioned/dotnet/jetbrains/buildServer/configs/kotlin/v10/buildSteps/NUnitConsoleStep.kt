...
open class NUnitConsoleStep : BuildStep {
    constructor(init: NUnitConsoleStep.() -> Unit = {}, base: NUnitConsoleStep? = null): super(base = base as BuildStep?) {
        type = "nunit-console"
        init()
    }
 ...
 */
fun BuildSteps.nunitConsole(base: NUnitConsoleStep? = null, init: NUnitConsoleStep.() -> Unit = {}) {
    step(NUnitConsoleStep(init, base))
}
