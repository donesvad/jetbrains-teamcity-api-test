...
open class NugetCacheFeature : BuildFeature {
    constructor(init: NugetCacheFeature.() -> Unit = {}, base: NugetCacheFeature? = null): super(base = base as BuildFeature?) {
 ...
 */
fun BuildFeatures.nugetCache(base: NugetCacheFeature? = null, init: NugetCacheFeature.() -> Unit = {}) {
    feature(NugetCacheFeature(init, base))
}
